...
Contributions are welcome. `go-ruby-bleve/bleve` is built to a small set of
...
The library is in [`github.com/go-ruby-bleve/bleve`](https://github.com/go-ruby-bleve/bleve).
This documentation site is in [`github.com/go-ruby-bleve/docs`](https://github.com/go-ruby-bleve/docs).
