...
`go-ruby-bleve/bleve` reimplements Ruby's `bleve` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-bleve/bleve` directly, with no Ruby runtime;
